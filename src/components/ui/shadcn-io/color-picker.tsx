...
export const ColorPicker = ({
  ...
  useEffect(() => {
    if (value) {
      ...
      if (
        newHue !== hueRef.current ||
        newSaturation !== saturationRef.current ||
        newLightness !== lightnessRef.current ||
        newAlpha !== alphaRef.current
      ) {
        setHue(newHue);
  ...
  // Notify parent of changes (only for user interactions after initialization, not controlled updates)
  useEffect(() => {
    if (onChange && !isControlledUpdate && isInitialized) {
